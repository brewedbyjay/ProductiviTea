...
const TOKENS: ColorToken[] = [
  ...
  { name: '--cb-red', label: 'Light red', context: 'Task count bar' },
  { name: '--cb-orange', label: 'Light orange', context: 'Task count bar' },
  { name: '--cb-yellow', label: 'Light yellow', context: 'Task count bar' },
  { name: '--cb-green', label: 'Light green', context: 'Task count bar' },
  { name: '--cb-cyan', label: 'Light cyan', context: 'Task count bar' },
  { name: '--cb-blue', label: 'Light blue', context: 'Task count bar' },
  { name: '--cb-purple', label: 'Light purple', context: 'Task count bar' },
  { name: '--cb-pink', label: 'Light pink', context: 'Task count bar' },
];
